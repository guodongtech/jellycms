...
function install_sql()
{
	...
	if($install_type == 'all')
	{
		...
		//检测SQL安装文件
		$sql_file = ROOT_PATH.'./install/jelly.sql';
...
';
	...
	if(!$is_success_admin)
	{
		showProgress(array('isError' => true,'message' => '生成admin.php页面出错','percent' => 0.9));
	}
	//index.php首页
...
$app->run();';
	...
	$is_success_index = file_put_contents($index_file,$index_content);
	if(!$is_success_index)
	{
