...
baidu.swf.createHTML = function (options) {
    ...
    options['codebase'] = '//fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0';
    ...
    options['pluginspage'] = '//www.macromedia.com/go/getflashplayer';
    str.push('<embed');
    var salign;
    for (k in options) {
        item = options[k];
